...
/*
#define BACKGROUND_   (1)  // reserved.frm
#define BACKGROUND_   (2)  // back1.frm
*/

#define BACKGROUND_RSTYMETL        (2)  // rstymetl.frm
#define BACKGROUND_HUB             (3)  // hub.frm
#define BACKGROUND_NECROPOLIS      (4)  // necro.frm
#define BACKGROUND_BROTHERHOOD     (5)  // bhood.frm
#define BACKGROUND_MILITARY_BASE   (6)  // military.frm
#define BACKGROUND_JUNKTOWN        (7)  // junktown.frm
#define BACKGROUND_CATHEDRAL       (8)  // cath.frm
#define BACKGROUND_SHADY_SANDS     (9) // shady.frm
